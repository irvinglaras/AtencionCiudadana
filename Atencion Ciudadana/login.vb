...
#End Region
    ...
    Private Function BuscarUsuario(ByVal sUsuario As String, ByVal sClave As String) As Boolean
        Try
            Dim sSQl As String = "select count(*) as total from usuarios where usuario='" & txtUsuario.Text & "' and clave='" & txtClave.Text & "'"
            ...
            If table.Rows.Count > 0 Then
                For Each dRow In table.Rows
                    If dRow("total") > 0 Then
                        ...
                        'My.Settings.Nombre = BuscaNombreUsuario()
                        My.Settings.sTipo = "Administrador"
                        Me.Hide()
